...
const ENEMYTROOPER_WIDTH = 75;
const ENEMYTROOPER_HEIGHT = 106;
const ENEMYLUKE_WIDTH = 50;
const ENEMYLUKE_HEIGHT = 138;
const MAX_ENEMIES = 5;
...
// const playEndGameSound = new Audio(sounds/Sad_Trombone.mp3);
const quitGame = 'Game over...';
const addEnemy = 'Add new enemy character...';
